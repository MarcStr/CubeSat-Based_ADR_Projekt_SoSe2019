...
\begin{document}																												%Erstellung des Schreibdokumentes 
 ...
 \tableofcontents																												%Erstellung eines Inhaltsverzeichnisses
  \newpage
	...
	\include{./header_hauptteil/missiondesign}														% -"- Mission Design												
  \include{./header_hauptteil/ausblick1}
	
	\include{./header_first/Abkuerzungen}
  ...
  %
  %---------------------------------------------------
 \chapter*{Abk\"urzungsverzeichnis}																					% Symbolverzeichnis
  \addcontentsline{toc}{chapter}{Abk\"urzungsverzeichnis}									% fügt Symbolverzeichnis trotz * in das Inhaltsverzeichnis ein
 ...
 \newpage
  ...
  %---------------------------------
		\begin{appendix}
			...
			\include{./header_verzeichnisse/anhang1}
		\end{appendix}
	\end{document}