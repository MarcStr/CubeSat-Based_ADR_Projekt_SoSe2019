...
\usepackage{tikz} 																			 % TikZ - ein geniales Zeichentool vor allem für Skizzen
																												 %oder Schemata, Programmabläufe, etc.
...
\title{\LARGE R XXXX X \newline CubeSat-based active debris removal}
\subtitle{Institut f\"ur Raumfahrtsysteme}
\author{Florian Czorny, Frederik Sch\"afer, \\ Marc Strempel, Oussama Mouhaya, \\ Valentina Dietrich}
...
\begin{document}
 ...
 \include{./header_first/aufgabenstellung1}
 \include{./header_first/eid1}
 \include{./header_first/abstract1}
 ...
 \tableofcontents
  \newpage
	...
	\include{./header_verzeichnisse/abkverzeichnis1}
	
	\include{./header_hauptteil/einleitung1}
	\include{./header_hauptteil/grundlagen1}
	%\include{./header_hauptteil/adrsubsysteme}
	\include{./header_hauptteil/cubesatdesign1}
	\include{./header_hauptteil/missiondesign}
	%\include{./header_hauptteil/ergebnisse1}
  \include{./header_hauptteil/zusammenfassung1}
  \include{./header_hauptteil/ausblick1}
 ...
 \glsaddall 
  ...
  %---------------------------------
		\begin{appendix}
			\include{./header_verzeichnisse/projekt}
